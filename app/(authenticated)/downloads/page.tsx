  ...
  return (
    <div className="min-h-[calc(100vh-0px)] bg-gradient-to-b from-slate-50 via-indigo-50/40 to-slate-100 print:min-h-0 print:h-auto print:bg-white print:m-0 print:p-0">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 space-y-6 print:max-w-none print:m-0 print:px-0 print:py-0 print:space-y-0">
        <div className="bg-white/85 backdrop-blur rounded-3xl shadow-sm border border-slate-200/70 px-6 py-5 print:hidden">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200/70 p-6 print:bg-transparent print:shadow-none print:border-0 print:m-0 print:p-0">
          <PublicScheduleList />
        </div>
      </div>
    </div>
